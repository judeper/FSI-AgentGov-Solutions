#!/usr/bin/env python3
"""
Create Dataverse schema for Hallucination Tracker.

Creates the HallucinationReport table with all columns, choice fields,
and supporting option sets for tracking and analyzing agent hallucination
patterns reported by users, supervisors, and automated systems.
"""
...
# HT-specific option sets
OPTIONSETS = {
    "fsi_HT_category": {
        "Name": "fsi_HT_category",
        "DisplayName": {"LocalizedLabels": [{"Label": "Hallucination Category", "LanguageCode": 1033}]},
        "Description": {"LocalizedLabels": [{"Label": "Category of hallucination reported", "LanguageCode": 1033}]},
        "OptionSetType": "Picklist",
        "IsGlobal": True,
        "Options": [
            {"Value": 100000000, "Label": {"LocalizedLabels": [{"Label": "FactualError", "LanguageCode": 1033}]}},
            {"Value": 100000001, "Label": {"LocalizedLabels": [{"Label": "FabricatedData", "LanguageCode": 1033}]}},
            {"Value": 100000002, "Label": {"LocalizedLabels": [{"Label": "CitationMissing", "LanguageCode": 1033}]}},
            {"Value": 100000003, "Label": {"LocalizedLabels": [{"Label": "OutdatedInfo", "LanguageCode": 1033}]}},
            {"Value": 100000004, "Label": {"LocalizedLabels": [{"Label": "ConfidenceOverstatement", "LanguageCode": 1033}]}},
        ],
    },
    "fsi_HT_severity": {
        "Name": "fsi_HT_severity",
        "DisplayName": {"LocalizedLabels": [{"Label": "Hallucination Severity", "LanguageCode": 1033}]},
        "Description": {"LocalizedLabels": [{"Label": "Severity level of the hallucination", "LanguageCode": 1033}]},
        "OptionSetType": "Picklist",
        "IsGlobal": True,
        "Options": [
            ...
            {"Value": 100000003, "Label": {"LocalizedLabels": [{"Label": "Critical", "LanguageCode": 1033}]}},
        ],
    },
    "fsi_HT_source": {
        "Name": "fsi_HT_source",
        "DisplayName": {"LocalizedLabels": [{"Label": "Report Source", "LanguageCode": 1033}]},
        "Description": {"LocalizedLabels": [{"Label": "Source of the hallucination report", "LanguageCode": 1033}]},
        "OptionSetType": "Picklist",
        "IsGlobal": True,
        "Options": [
...
# Table definitions
TABLES = {
    "fsi_HallucinationReport": {
        "SchemaName": "fsi_HallucinationReport",
        "DisplayName": {"LocalizedLabels": [{"Label": "Hallucination Report", "LanguageCode": 1033}]},
        "DisplayCollectionName": {"LocalizedLabels": [{"Label": "Hallucination Reports", "LanguageCode": 1033}]},
        "Description": {"LocalizedLabels": [{"Label": "Tracks hallucination reports for AI agent responses including category, severity, and remediation status", "LanguageCode": 1033}]},
        ...
        "PrimaryNameAttribute": f"{PUBLISHER_PREFIX}_reportname",
    },
}
    ...
    "fsi_hallucinationreport": [
        {
            ...
            "Description": {"LocalizedLabels": [{"Label": "Category of hallucination reported", "LanguageCode": 1033}]},
            "GlobalOptionSet@odata.bind": "/GlobalOptionSetDefinitions(Name='fsi_HT_category')",
        },
        {
            "@odata.type": "Microsoft.Dynamics.CRM.PicklistAttributeMetadata",
            ...
            "Description": {"LocalizedLabels": [{"Label": "Severity level of the hallucination", "LanguageCode": 1033}]},
            "GlobalOptionSet@odata.bind": "/GlobalOptionSetDefinitions(Name='fsi_HT_severity')",
        },
        {
            "@odata.type": "Microsoft.Dynamics.CRM.StringAttributeMetadata",
            ...
            "Description": {"LocalizedLabels": [{"Label": "Unique identifier of the agent that produced the hallucination", "LanguageCode": 1033}]},
            "MaxLength": 100,
            "FormatName": {"Value": "Text"},
        },
        {
        ...
        },
        {
            ...
            "Description": {"LocalizedLabels": [{"Label": "Detailed description of the hallucination", "LanguageCode": 1033}]},
            "MaxLength": 100000,
            "Format": "Text",
        },
        {
            "@odata.type": "Microsoft.Dynamics.CRM.PicklistAttributeMetadata",
            "SchemaName": f"{PUBLISHER_PREFIX}_Source",
            "RequiredLevel": {"Value": "None"},
            "DisplayName": {"LocalizedLabels": [{"Label": "Source", "LanguageCode": 1033}]},
            "Description": {"LocalizedLabels": [{"Label": "Source of the hallucination report", "LanguageCode": 1033}]},
            "GlobalOptionSet@odata.bind": "/GlobalOptionSetDefinitions(Name='fsi_HT_source')",
        },
        {
            "@odata.type": "Microsoft.Dynamics.CRM.StringAttributeMetadata",
            "SchemaName": f"{PUBLISHER_PREFIX}_ReportedBy",
            "RequiredLevel": {"Value": "None"},
            "DisplayName": {"LocalizedLabels": [{"Label": "Reported By", "LanguageCode": 1033}]},
            "Description": {"LocalizedLabels": [{"Label": "Name or identifier of the person who submitted the report", "LanguageCode": 1033}]},
            "MaxLength": 200,
            "FormatName": {"Value": "Text"},
        },
        {
            "@odata.type": "Microsoft.Dynamics.CRM.DateTimeAttributeMetadata",
            "SchemaName": f"{PUBLISHER_PREFIX}_ReportedAt",
            "RequiredLevel": {"Value": "None"},
            "DisplayName": {"LocalizedLabels": [{"Label": "Reported At", "LanguageCode": 1033}]},
            "Description": {"LocalizedLabels": [{"Label": "Timestamp when the hallucination was reported", "LanguageCode": 1033}]},
            "Format": "DateAndTime",
            "DateTimeBehavior": {"Value": "UserLocal"},
        },
        {
            "@odata.type": "Microsoft.Dynamics.CRM.StringAttributeMetadata",
            "SchemaName": f"{PUBLISHER_PREFIX}_ConversationId",
            "RequiredLevel": {"Value": "None"},
            "DisplayName": {"LocalizedLabels": [{"Label": "Conversation ID", "LanguageCode": 1033}]},
            "Description": {"LocalizedLabels": [{"Label": "Identifier of the conversation where the hallucination occurred", "LanguageCode": 1033}]},
            "MaxLength": 200,
            "FormatName": {"Value": "Text"},
        },
        {
            "@odata.type": "Microsoft.Dynamics.CRM.MemoAttributeMetadata",
            "SchemaName": f"{PUBLISHER_PREFIX}_UserQuery",
            "RequiredLevel": {"Value": "None"},
            "DisplayName": {"LocalizedLabels": [{"Label": "User Query", "LanguageCode": 1033}]},
        ...
        {
            "@odata.type": "Microsoft.Dynamics.CRM.MemoAttributeMetadata",
            "SchemaName": f"{PUBLISHER_PREFIX}_AgentResponse",
            "RequiredLevel": {"Value": "None"},
            "DisplayName": {"LocalizedLabels": [{"Label": "Agent Response", "LanguageCode": 1033}]},
            "Description": {"LocalizedLabels": [{"Label": "The agent response containing the hallucination", "LanguageCode": 1033}]},
            "MaxLength": 100000,
            "Format": "Text",
        },
        {
            "@odata.type": "Microsoft.Dynamics.CRM.MemoAttributeMetadata",
            "SchemaName": f"{PUBLISHER_PREFIX}_CorrectAnswer",
            "RequiredLevel": {"Value": "None"},
            "DisplayName": {"LocalizedLabels": [{"Label": "Correct Answer", "LanguageCode": 1033}]},
            "Description": {"LocalizedLabels": [{"Label": "The correct or expected answer for comparison", "LanguageCode": 1033}]},
            "MaxLength": 100000,
            "Format": "Text",
        },
        {
            ...
            "Description": {"LocalizedLabels": [{"Label": "Whether this hallucination report has been resolved", "LanguageCode": 1033}]},
            "DefaultValue": False,
            "OptionSet": {
        ...
        },
        {
            ...
            "RequiredLevel": {"Value": "None"},
            "DisplayName": {"LocalizedLabels": [{"Label": "Resolved By", "LanguageCode": 1033}]},
            "Description": {"LocalizedLabels": [{"Label": "Name or identifier of the person who resolved the report", "LanguageCode": 1033}]},
            "MaxLength": 200,
            "FormatName": {"Value": "Text"},
        },
        {
            ...
            "Description": {"LocalizedLabels": [{"Label": "Timestamp when the hallucination report was resolved", "LanguageCode": 1033}]},
            "Format": "DateAndTime",
            "DateTimeBehavior": {"Value": "UserLocal"},
        },
        {
            ...
            "Description": {"LocalizedLabels": [{"Label": "Notes on actions taken to remediate the hallucination", "LanguageCode": 1033}]},
            "MaxLength": 100000,
            "Format": "Text",
        },
    ],
...
# No relationships for HT tables
RELATIONSHIPS = []
...
def generate_schema_docs() -> str:
    ...
    lines.append("")
    lines.append("> Auto-generated from `create_ht_dataverse_schema.py`. Do not edit manually.")
    lines.append("")
    ...
    for table_schema_name, tbl in TABLES.items():
        ...
        # Include any lookup columns from relationships
...
def create_optionsets(client: DataverseClient, dry_run: bool) -> dict:
    """Create global option sets for Hallucination Tracker."""
...
def main():
    ...
    parser.add_argument("--tenant-id", default=os.environ.get("HT_TENANT_ID"), help="Entra ID tenant ID (or set HT_TENANT_ID env var)")
    parser.add_argument("--client-id", default=os.environ.get("HT_CLIENT_ID"), help="Application (client) ID (or set HT_CLIENT_ID env var)")
    parser.add_argument("--environment-url", default=os.environ.get("HT_ENVIRONMENT_URL"), help="Dataverse environment URL (or set HT_ENVIRONMENT_URL env var)")
    ...
    if not args.tenant_id or not args.environment_url:
        parser.error("Missing required arguments. Provide --tenant-id and --environment-url (or set HT_TENANT_ID and HT_ENVIRONMENT_URL env vars)")
