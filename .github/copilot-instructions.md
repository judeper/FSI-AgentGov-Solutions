...
| agent-sharing-access-restriction-detector | v1.0.3 | 1.18, 2.8 | Zone-based agent sharing policy enforcement with approval workflows |
...
| conditional-access-automation | v1.2.0 | 1.11, 1.23, 1.18 | CA policy deployment, compliance monitoring, and drift detection |
...
| cross-solution-integration | v1.0.1 | 1.7, 1.23, 1.11, 3.8, 1.8, 1.14 | Wires Tier 2 solutions into Compliance Dashboard |
...
| rag-source-validator | v1.1.0 | 2.16, 1.7, 2.13 | Integrity validation for RAG knowledge sources |
| scope-drift-monitor | v1.1.1 | 1.14, 1.4, 1.5 | Detect agent data access beyond declared scope |
