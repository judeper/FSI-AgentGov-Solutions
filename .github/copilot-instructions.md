...
|----------|---------|-----------------|-------------|
| action-confirmation-auditor | v1.2.3 | 2.12, 1.10 | HITL confirmation step validation in Copilot Studio agent topics |
...
| generative-ai-config-auditor | v1.2.3 | 2.24 | GenAI feature enablement governance per zone |
