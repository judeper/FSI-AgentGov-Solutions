...
| agent-communication-restriction-detector | v1.2.0 | 2.17 | Detects unauthorized agent-to-agent communication patterns, zone boundary violations, cross-tenant communication, and maker/checker violations in Copilot Studio multi-agent orchestration |
...
| agent-observability-foundation | v1.2.1 | 1.7, 2.8, 2.9, 3.2 | Foundational observability infrastructure for agent monitoring |
...
| generative-ai-config-auditor | v1.2.0 | 2.24 | GenAI feature enablement governance per zone |
...
| model-risk-management-automation | v1.0.3 | 2.6, 2.5, 2.9, 2.11, 2.13, 3.1, 1.2 | OCC 2011-12 / SR 11-7 model risk management with inventory, risk scoring, validation workflows, and Agent Card generation |
...
| session-security-configurator | v1.2.0 | 1.23, 1.11 | Session security validation per governance zone with drift detection |
