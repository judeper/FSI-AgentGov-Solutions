#!/usr/bin/env python3
"""
Create Dataverse schema for Inactivity Timeout Enforcement.

Creates EnvironmentPolicy, InactivityTimeoutCompliance, and InactivityTimeoutErrorLog
tables with all columns, choice fields, and supporting option sets.
...
OPTIONSETS = {
    "fsi_ITE_compliancestatus": {
        ...
        "Description": {"LocalizedLabels": [{"Label": "Inactivity timeout compliance status", "LanguageCode": 1033}]},
        "OptionSetType": "Picklist",
        "IsGlobal": True,
        "Options": [
            ...
            {"Value": 100000002, "Label": {"LocalizedLabels": [{"Label": "Unknown", "LanguageCode": 1033}]}},
        ],
    },
    "fsi_ITE_errortype": {
        "Name": "fsi_ITE_errortype",
        "DisplayName": {"LocalizedLabels": [{"Label": "Error Type", "LanguageCode": 1033}]},
        "Description": {"LocalizedLabels": [{"Label": "Type of error encountered during scan", "LanguageCode": 1033}]},
        "OptionSetType": "Picklist",
        "IsGlobal": True,
        "Options": [
            {"Value": 100000000, "Label": {"LocalizedLabels": [{"Label": "MissingPolicy", "LanguageCode": 1033}]}},
            {"Value": 100000001, "Label": {"LocalizedLabels": [{"Label": "Unauthorized", "LanguageCode": 1033}]}},
            {"Value": 100000002, "Label": {"LocalizedLabels": [{"Label": "Forbidden", "LanguageCode": 1033}]}},
            {"Value": 100000003, "Label": {"LocalizedLabels": [{"Label": "NotFound", "LanguageCode": 1033}]}},
            {"Value": 100000004, "Label": {"LocalizedLabels": [{"Label": "Throttled", "LanguageCode": 1033}]}},
            {"Value": 100000005, "Label": {"LocalizedLabels": [{"Label": "ParseError", "LanguageCode": 1033}]}},
            {"Value": 100000006, "Label": {"LocalizedLabels": [{"Label": "DataverseError", "LanguageCode": 1033}]}},
        ],
    },
}
...
TABLES = {
    "fsi_EnvironmentPolicy": {
        ...
        "DisplayName": {"LocalizedLabels": [{"Label": "Environment Policy", "LanguageCode": 1033}]},
        "DisplayCollectionName": {"LocalizedLabels": [{"Label": "Environment Policies", "LanguageCode": 1033}]},
        "Description": {"LocalizedLabels": [{"Label": "Zone policy configuration per environment for inactivity timeout", "LanguageCode": 1033}]},
        ...
        "Attributes": [
            {
                ...
                "Description": {"LocalizedLabels": [{"Label": "Unique policy name", "LanguageCode": 1033}]},
                "MaxLength": 200,
    ...
    "fsi_InactivityTimeoutCompliance": {
        ...
        "DisplayName": {"LocalizedLabels": [{"Label": "Inactivity Timeout Compliance", "LanguageCode": 1033}]},
        "DisplayCollectionName": {"LocalizedLabels": [{"Label": "Inactivity Timeout Compliance Records", "LanguageCode": 1033}]},
        "Description": {"LocalizedLabels": [{"Label": "Immutable scan results for inactivity timeout compliance", "LanguageCode": 1033}]},
        "OwnershipType": "OrganizationOwned",
        "IsActivity": False,
        "IsAuditEnabled": {"Value": True},
        "HasActivities": False,
        ...
        "Attributes": [
            {
                "@odata.type": "Microsoft.Dynamics.CRM.StringAttributeMetadata",
                "SchemaName": f"{PUBLISHER_PREFIX}_ComplianceName",
                "RequiredLevel": {"Value": "ApplicationRequired"},
                "DisplayName": {"LocalizedLabels": [{"Label": "Compliance Name", "LanguageCode": 1033}]},
                "Description": {"LocalizedLabels": [{"Label": "Unique compliance record identifier", "LanguageCode": 1033}]},
                "MaxLength": 200,
                "FormatName": {"Value": "Text"},
            }
        ],
        "PrimaryNameAttribute": f"{PUBLISHER_PREFIX}_compliancename",
    },
    "fsi_InactivityTimeoutErrorLog": {
        "SchemaName": "fsi_InactivityTimeoutErrorLog",
        "DisplayName": {"LocalizedLabels": [{"Label": "Inactivity Timeout Error Log", "LanguageCode": 1033}]},
        "DisplayCollectionName": {"LocalizedLabels": [{"Label": "Inactivity Timeout Error Logs", "LanguageCode": 1033}]},
        "Description": {"LocalizedLabels": [{"Label": "Error audit trail for inactivity timeout scans", "LanguageCode": 1033}]},
        "OwnershipType": "OrganizationOwned",
        "IsActivity": False,
        "IsAuditEnabled": {"Value": True},
        "HasActivities": False,
        ...
        "Attributes": [
            {
                "@odata.type": "Microsoft.Dynamics.CRM.StringAttributeMetadata",
                "SchemaName": f"{PUBLISHER_PREFIX}_ErrorName",
                "RequiredLevel": {"Value": "ApplicationRequired"},
                "DisplayName": {"LocalizedLabels": [{"Label": "Error Name", "LanguageCode": 1033}]},
                "Description": {"LocalizedLabels": [{"Label": "Unique error record identifier", "LanguageCode": 1033}]},
                "MaxLength": 200,
                "FormatName": {"Value": "Text"},
            }
        ],
        "PrimaryNameAttribute": f"{PUBLISHER_PREFIX}_errorname",
    },
}
...
COLUMNS = {
    "fsi_environmentpolicy": [
        ...
        },
        {
            ...
            "SchemaName": f"{PUBLISHER_PREFIX}_RequiredMaxDuration",
            "RequiredLevel": {"Value": "ApplicationRequired"},
            "DisplayName": {"LocalizedLabels": [{"Label": "Required Max Duration (Minutes)", "LanguageCode": 1033}]},
            "Description": {"LocalizedLabels": [{"Label": "Maximum inactivity timeout in minutes", "LanguageCode": 1033}]},
            "MinValue": 0,
            "MaxValue": 999999,
            "Format": "None",
        },
    ...
    "fsi_inactivitytimeoutcompliance": [
        ...
        {
            "@odata.type": "Microsoft.Dynamics.CRM.BooleanAttributeMetadata",
            "SchemaName": f"{PUBLISHER_PREFIX}_InactivityTimeoutEnabled",
            "RequiredLevel": {"Value": "None"},
            "DisplayName": {"LocalizedLabels": [{"Label": "Inactivity Timeout Enabled", "LanguageCode": 1033}]},
            "Description": {"LocalizedLabels": [{"Label": "Whether inactivity timeout is enabled on the environment", "LanguageCode": 1033}]},
            "DefaultValue": False,
            "OptionSet": {
                "TrueOption": {"Value": 1, "Label": {"LocalizedLabels": [{"Label": "Yes", "LanguageCode": 1033}]}},
                "FalseOption": {"Value": 0, "Label": {"LocalizedLabels": [{"Label": "No", "LanguageCode": 1033}]}},
        ...
        {
            "@odata.type": "Microsoft.Dynamics.CRM.StringAttributeMetadata",
            "SchemaName": f"{PUBLISHER_PREFIX}_TimeoutDuration",
            "RequiredLevel": {"Value": "None"},
            "DisplayName": {"LocalizedLabels": [{"Label": "Timeout Duration", "LanguageCode": 1033}]},
            "Description": {"LocalizedLabels": [{"Label": "Configured timeout duration (ISO 8601 or minutes)", "LanguageCode": 1033}]},
            "MaxLength": 50,
            "FormatName": {"Value": "Text"},
        },
        {
            ...
            "RequiredLevel": {"Value": "None"},
            "DisplayName": {"LocalizedLabels": [{"Label": "Required Max Duration (Minutes)", "LanguageCode": 1033}]},
            "Description": {"LocalizedLabels": [{"Label": "Maximum inactivity timeout required by policy in minutes", "LanguageCode": 1033}]},
            "MinValue": 0,
            "MaxValue": 999999,
            "Format": "None",
        },
        ...
        },
        {
            ...
            "Description": {"LocalizedLabels": [{"Label": "Additional notes or details about the compliance result", "LanguageCode": 1033}]},
            "MaxLength": 100000,
            "Format": "Text",
        },
        {
            "@odata.type": "Microsoft.Dynamics.CRM.DateTimeAttributeMetadata",
            "SchemaName": f"{PUBLISHER_PREFIX}_LastScanDate",
            "RequiredLevel": {"Value": "None"},
            "DisplayName": {"LocalizedLabels": [{"Label": "Last Scan Date", "LanguageCode": 1033}]},
            "Description": {"LocalizedLabels": [{"Label": "When this compliance record was last scanned", "LanguageCode": 1033}]},
            "Format": "DateAndTime",
    ...
    "fsi_inactivitytimeouterrorlog": [
        ...
        {
            "@odata.type": "Microsoft.Dynamics.CRM.PicklistAttributeMetadata",
            "SchemaName": f"{PUBLISHER_PREFIX}_ErrorType",
            "RequiredLevel": {"Value": "ApplicationRequired"},
            "DisplayName": {"LocalizedLabels": [{"Label": "Error Type", "LanguageCode": 1033}]},
            "Description": {"LocalizedLabels": [{"Label": "Type of error encountered during scan", "LanguageCode": 1033}]},
            "GlobalOptionSet@odata.bind": "/GlobalOptionSetDefinitions(Name='fsi_ITE_errortype')",
        },
        {
            "@odata.type": "Microsoft.Dynamics.CRM.MemoAttributeMetadata",
            "SchemaName": f"{PUBLISHER_PREFIX}_ErrorRaw",
            "RequiredLevel": {"Value": "None"},
            "DisplayName": {"LocalizedLabels": [{"Label": "Error Raw", "LanguageCode": 1033}]},
            "Description": {"LocalizedLabels": [{"Label": "Raw error message or stack trace", "LanguageCode": 1033}]},
            "MaxLength": 100000,
            "Format": "Text",
        },
        {
            ...
            "Description": {"LocalizedLabels": [{"Label": "When the error occurred", "LanguageCode": 1033}]},
            "Format": "DateAndTime",
            "DateTimeBehavior": {"Value": "UserLocal"},
        },
    ],
...
# No relationships for ITE tables
RELATIONSHIPS = []
...
def generate_schema_docs() -> str:
    ...
    lines.append("")
    lines.append("> Auto-generated from `create_ite_dataverse_schema.py`. Do not edit manually.")
    lines.append("")
...
def create_optionsets(client: DataverseClient, dry_run: bool) -> dict:
    """Create global option sets (shared and ITE-specific)."""
    ...
    # Create ITE-specific option sets
    print("\nITE-specific option sets:")
