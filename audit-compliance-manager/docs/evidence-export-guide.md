...
- Az.Accounts module for authentication (`Install-Module Az.Accounts -Scope CurrentUser`)
...
|-------|-------|-----------|
| Authentication failure | Missing Az.Accounts module | Run `Install-Module Az.Accounts -Scope CurrentUser` |
