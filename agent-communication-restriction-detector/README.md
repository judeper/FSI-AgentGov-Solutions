...
| **Child-Agent Payload Size Checks** | Estimates child-agent input/output declarations against a configurable advisory payload-size threshold (default 1 MB; current Copilot Studio docs publish a 5 MB connector payload limit) |
