#!/usr/bin/env python3
"""ACRDClient - Dataverse Web API client for Agent Communication Restriction Detector.
...
class ACRDClient:
    ...
    def query(
        ...
        Args:
            entity_set: Entity set name (e.g., 'fsi_agentcommviolations')
    ...
    def get_entity_metadata(self, logical_name: str) -> Optional[dict]:
        ...
        Args:
            logical_name: Entity logical name (e.g., 'fsi_agentcommviolation')
    ...
    def create_table(
        ...
        Args:
            name: Table schema name (e.g., 'fsi_AgentCommViolation')
