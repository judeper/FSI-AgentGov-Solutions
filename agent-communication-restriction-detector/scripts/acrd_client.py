#!/usr/bin/env python3
"""ACRDClient - DEPRECATED Dataverse Web API client stub.

.. deprecated:: 1.2.1
    This module is deprecated since v1.2.1. Use the shared DataverseClient
    (see CHANGELOG.md) which is imported by all create_*.py scripts.
...
warnings.warn(
    "acrd_client.ACRDClient is deprecated since v1.2.1. "
...
raise ImportError(
    "acrd_client has been removed. Use the shared DataverseClient instead. "
