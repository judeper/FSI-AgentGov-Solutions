#!/usr/bin/env python3
"""Deploy Content Moderation Monitor infrastructure to Dataverse.

Orchestrates the full deployment pipeline:
  1. Test Connection — validate Dataverse API access
  2. Dataverse Schema — tables, columns, shared option sets
...
def run_deployment(
    ...
    print()
    print("=" * 60)
    print("Content Moderation Monitor — Dataverse Deployment")
    print("=" * 60)
