#!/usr/bin/env python3
"""CMMClient - Dataverse Web API client for Content Moderation Monitor.
...
class CMMClient:
    ...
    def query(
        ...
        Args:
            entity_set: Entity set name (e.g., 'fsi_moderationbaselines')
    ...
    def get_entity_metadata(self, logical_name: str) -> Optional[dict]:
        ...
        Args:
            logical_name: Entity logical name (e.g., 'fsi_moderationbaseline')
    ...
    def create_table(
        ...
        Args:
            name: Table schema name (e.g., 'fsi_ModerationBaseline')
...
def main() -> None:
    """CLI entry point for CMMClient standalone testing."""
    parser = argparse.ArgumentParser(
        description="CMMClient - Dataverse Web API client for Content Moderation Monitor",
