...
BASELINE_COLUMNS = [
    ...
    _boolean_col("fsi_ModelKnowledgeEnabled", "Model Knowledge Enabled",
                 default=False,
                 description="Whether AI general knowledge (Model Knowledge) is enabled"),
    _boolean_col("fsi_SemanticSearchEnabled", "Semantic Search Enabled",
                 default=False,
                 description="Whether Dataverse Semantic Search (vector search) is enabled"),
