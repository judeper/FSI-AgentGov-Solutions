#!/usr/bin/env python3
"""GACClient - Dataverse Web API client for Generative AI Config Auditor.
...
class GACClient:
    ...
    def query(
        ...
        Args:
            entity_set: Entity set name (e.g., 'fsi_gacbaselines')
    ...
    def get_entity_metadata(self, logical_name: str) -> Optional[dict]:
        ...
        Args:
            logical_name: Entity logical name (e.g., 'fsi_gacbaseline')
    ...
    def create_table(
        ...
        Args:
            name: Table schema name (e.g., 'fsi_GACBaseline')
