...
Target Dataverse environment URL, for example https://<your-env>.crm.dynamics.com.
...
.EXAMPLE
pwsh .\scripts\provision_solution_shell.ps1 -EnvironmentUrl https://<your-env>.crm.dynamics.com

.EXAMPLE
pwsh .\scripts\provision_solution_shell.ps1 `
  -EnvironmentUrl https://<your-env>.crm.dynamics.com `
  -EnvVarValues @{ fsi_intake_makerportalurl = 'https://example.powerpagesportals.com/agent-intake' }

.EXAMPLE
pwsh .\scripts\provision_solution_shell.ps1 `
  -EnvironmentUrl https://<your-env>.crm.dynamics.com `
  -GraphCustomConnectorApiId shared_exampleGraphConnector `
  -DryRun
#>
[CmdletBinding()]
