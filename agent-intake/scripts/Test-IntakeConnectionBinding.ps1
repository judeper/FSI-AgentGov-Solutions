...
.EXAMPLE
    ./Test-IntakeConnectionBinding.ps1 -EnvironmentUrl https://<your-env>.crm.dynamics.com/

    Reports every fsi_cr_* connection reference and gates on the three vertical-slice references.

.EXAMPLE
    ./Test-IntakeConnectionBinding.ps1 -EnvironmentUrl https://<your-env>.crm.dynamics.com/ -RequireBound fsi_cr_dataverse_agentintake,fsi_cr_teams_agentintake,fsi_cr_office365_agentintake,fsi_cr_http_agentintake,fsi_cr_graph_agentintake
