...
# Bootstrap (one-time)
az login --tenant <your-tenant-id>
pac auth create --name FSI-Lab --environment https://<your-env>.crm.dynamics.com --deviceCode

# Preflight
.\Test-LabAuthReadiness.ps1 -EnvironmentUrl https://<your-env>.crm.dynamics.com
