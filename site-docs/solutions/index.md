...
36 live reference implementations organized by functional domain.
...
| [Conditional Access Automation](conditional-access-automation/index.md) | Automated deployment and compliance monitoring of Entra ID Conditional Access policies for Microsoft 365 AI workloads (Copilot Studio, Agent Builder, M365 Copilot). | v1.2.2 | live | team, enterprise | 1.11, 1.23, 1.18 |
...
| [MIME Type Restrictions for File Uploads](mime-type-restrictions/index.md) | Dataverse plugin, DLP policy template, and Sentinel queries for MIME type restriction governance in Copilot Studio agent file upload scenarios. | v1.1.0 | live | personal, team, enterprise | 1.5, 1.10, 1.11, 1.13, 1.14, 1.25, 3.3, 3.7, 4.3 |
...
| [Cross-Solution Integration](cross-solution-integration/index.md) | Integration layer that connects the Tier 2 governance solutions into the Compliance Dashboard and Environment Lifecycle Management workflow. | v2.0.0 | live | personal, team, enterprise | 1.7, 1.23, 1.11, 3.8, 1.8, 1.14 |
