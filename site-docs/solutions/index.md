...
| Solution | Description | Version | Status | Zones | Controls |
|----------|-------------|---------|--------|-------|----------|
| [Agent Observability Foundation](agent-observability-foundation/index.md) | FSI-compliant telemetry infrastructure for Microsoft Copilot Studio agents with long-term audit retention, operational workbooks, and proactive alerting. | v1.2.3 | live | personal, team, enterprise | 1.7, 2.8, 2.9, 3.2 |
