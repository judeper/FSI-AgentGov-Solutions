...
#
# NOTE (v1.1.0): `fsi_acv_zone` retains 0-based values because it is shared with
# six or more solutions (ACRD, ASARD, ALG, ARA, ACV, etc.). Migrating it in
# isolation would create cross-solution inconsistency. The 0-based values here
# match every other schema script in the repo; the 100000000-based hardcoding
# in cross-solution-integration/scripts/powershell/IntegrationConfig.psm1 is a
# known cross-solution inconsistency tracked for a future cross-solution PR.
# This exception is allowlisted by style-decisions.md §9.
# =============================================================================
