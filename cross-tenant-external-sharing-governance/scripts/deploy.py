...
def _print_post_deployment(is_dry_run: bool):
    ...
    if is_dry_run:
        ...
        print("  \u2713 Environment Variables: 13 variables (fsi_CTSG_*)")
        print("  \u2713 Connection References: 8 references (fsi_cr_*_ctsg*)")
        print()
        print("  POST-DEPLOYMENT STEPS:")
        print("  1. Set fsi_CTSG_GovernanceTeamEmail, fsi_CTSG_GovernanceCommitteeUPN,")
        print("     fsi_CTSG_SecurityTeamUPN, fsi_CTSG_FlowAdministrators, and")
        print("     fsi_CTSG_GovernanceTeamChannelId")
        ...
        print("     - Rebind fsi_cr_graph_ctsg_* to your HTTP-with-Entra connection")
        print("  3. Populate the fsi_approvedexternaltenant table before enabling governance")
