#!/usr/bin/env python3
"""
Create Dataverse environment variables for Agent Sharing Access Restriction Detector.

Environment variables store configurable settings for adaptive card templates,
BAP Admin API integration, approval timeouts, and governance lead contacts.
"""
...
ENV_VARIABLES = [
    {
        ...
        "displayname": "ASARD - Adaptive Card Template URL",
        "description": "URL for adaptive card templates used in sharing restriction notifications",
        "type": "String",
        "defaultvalue": "",
    },
    {
        "schemaname": "fsi_ASARD_BAPAdminAPIBaseUrl",
        "displayname": "ASARD - BAP Admin API Base URL",
        "description": "BAP Admin API base URL for agent and environment discovery",
        "type": "String",
    ...
    {
        "schemaname": "fsi_ASARD_GovernanceLeadEmail",
        "displayname": "ASARD - Governance Lead Email",
        "description": "Governance lead email address for sharing restriction approvals and escalations",
        "type": "String",
        "defaultvalue": "",
    },
]
...
def create_environment_variables(client: DataverseClient, dry_run: bool = False) -> dict:
    """
    Create environment variables for sharing access restriction detection and remediation.
...
def main() -> None:
    """CLI entry point for ASARD environment variable creation."""
    parser = argparse.ArgumentParser(
        description="Create environment variables for Agent Sharing Access Restriction Detector",
...
Examples:
  ...
  python create_asard_environment_variables.py \\
      --tenant-id <tenant-id> \\
