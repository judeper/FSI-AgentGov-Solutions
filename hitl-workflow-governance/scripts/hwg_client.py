...
class HWGClient:
    ...
    def query(
        ...
        Args:
            entity_set: Entity set name (e.g., 'fsi_hitlcheckpointresults')
    ...
    def get_entity_metadata(self, logical_name: str) -> Optional[dict]:
        ...
        Args:
            logical_name: Entity logical name (e.g., 'fsi_hitlcheckpointresult')
    ...
    def create_table(
        ...
        Args:
            name: Table schema name (e.g., 'fsi_HitlCheckpointResult')
