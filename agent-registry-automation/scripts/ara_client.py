...
class ARAClient:
    ...
    def get_entity_metadata(self, logical_name: str) -> Optional[dict]:
        ...
        Args:
            logical_name: Entity logical name (e.g., 'fsi_agentinventory')
    ...
    def get_global_optionset(self, name: str) -> Optional[dict]:
        ...
        Args:
            name: OptionSet name (e.g., 'fsi_ara_registrationstatus')
    ...
    def create_table(
        ...
        Args:
            name: Table schema name (e.g., 'fsi_AgentInventory')
    ...
    def create_option_set(
        ...
        Args:
            name: Option set name (e.g., 'fsi_ara_registrationstatus')
