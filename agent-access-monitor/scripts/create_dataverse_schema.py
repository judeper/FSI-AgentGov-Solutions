...
def create_shared_optionsets(client: AAMClient, dry_run: bool = False) -> None:
    """
...
def create_tables(client: AAMClient, dry_run: bool = False) -> None:
...
def create_columns(client: AAMClient, dry_run: bool = False) -> None:
