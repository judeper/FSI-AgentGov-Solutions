...
| No pipelines anywhere (verified via `pac pipeline list`) | Greenfield (clean state) | Create custom host → Set as default → See [README.md Greenfield section](https://github.com/judeper/FSI-AgentGov-Solutions/blob/main/pipeline-governance-cleanup/README.md#new-deployment-greenfield) |
