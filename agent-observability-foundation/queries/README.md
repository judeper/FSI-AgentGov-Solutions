...
All queries align with the [FSI-AgentGov framework](https://github.com/judeper/FSI-AgentGov) 62-control governance model and include inline control references for audit traceability.
