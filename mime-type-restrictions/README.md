...
| Control | Description |
|---------|-------------|
| [1.5](https://judeper.github.io/FSI-AgentGov-Solutions/reference/control-mapping/#control-1-5) | Data Loss Prevention (DLP) and Sensitivity Labels |
| [1.13](https://judeper.github.io/FSI-AgentGov-Solutions/reference/control-mapping/#control-1-13) | Sensitive Information Types (SITs) and Pattern Recognition |
| [1.25](https://judeper.github.io/FSI-AgentGov-Solutions/reference/control-mapping/#control-1-25) | MIME Type Restrictions for File Uploads |
| [3.3](https://judeper.github.io/FSI-AgentGov-Solutions/reference/control-mapping/#control-3-3) | Compliance and Regulatory Reporting |
| [3.7](https://judeper.github.io/FSI-AgentGov-Solutions/reference/control-mapping/#control-3-7) | PPAC Security Posture Assessment |
