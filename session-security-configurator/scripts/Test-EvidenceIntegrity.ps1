...
<#
.SYNOPSIS
    Verifies SHA-256 integrity of session security validation evidence files.
...
.DESCRIPTION
    ...
    Evidence files produced by Export-SessionSecurityEvidence include SHA-256
    ...
    This script is part of the Session Security Configurator solution for
    FSI-AgentGov Control 1.23 (Session Security and Step-Up Authentication).
...
.EXAMPLE
    .\Test-EvidenceIntegrity.ps1 -EvidenceFilePath ".\evidence\session-security-evidence-Zone3-20260209-143022.json"
...
.EXAMPLE
    $isValid = .\Test-EvidenceIntegrity.ps1 `
        -EvidenceFilePath ".\evidence\session-security-evidence-Zone3-20260209-143022.json" `
        -Quiet
...
.NOTES
    ...
    - Example: "abc123...  session-security-evidence-Zone3-20260209-143022.json"
    ...
    - GLBA 501(b) (user identity verification controls)
#>
